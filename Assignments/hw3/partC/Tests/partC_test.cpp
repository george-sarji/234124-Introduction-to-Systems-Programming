...
#define ASSERT_NO_ERROR(x)                                                                               \
    ...
    {                                                                                                    \
        ...
        {                                                                                                \
            cout << "Failed assertion at line " << __LINE__ << " in " << __func__ << ": received error " \
                 << "\"" << e.what() << "\""                                                             \
                 << " while expecting no errors" << endl;                                                \
            return false;                                                                                \
        }                                                                                                \
    } while (false);

// Asserts that x causes this error (and no other error)
#define ASSERT_ERROR(x, error)                                                                                                                 \
    do                                                                                                                                         \
    {                                                                                                                                          \
        try                                                                                                                                    \
        {                                                                                                                                      \
            x;                                                                                                                                 \
            cout << "Failed assertion at line " << __LINE__ << " in " << __func__ << ": received no error while expecting " << #error << endl; \
            return false;                                                                                                                      \
        }                                                                                                                                      \
        catch (error & e)                                                                                                                      \
        {                                                                                                                                      \
...
#define ASSERT_ERROR_WITH_MESSAGE(x, error, message)                                                                                           \
    do                                                                                                                                         \
    {                                                                                                                                          \
        try                                                                                                                                    \
        {                                                                                                                                      \
        ...
        {                                                                                                                                      \
            ASSERT_TEST(string(e.what()) == (message));                                                                                        \
        }                                                                                                                                      \
        catch (const GameException &e)                                                                                                         \
        {                                                                                                                                      \
            cout << "Failed assertion at line " << __LINE__ << " in " << __func__ << ": received error: "                                      \
