...
public:
    ...
    DependencyFinder(const DependencyFinder &other)
    {
        used["cctor"] = true;
        data = other.data;
    }
    DependencyFinder &operator=(const DependencyFinder &other)
    {
        used["="] = true;
        data = other.data;
        return *this;
    ...
    DependencyFinder operator+(const DependencyFinder &other) const
    {
        used["+"] = true;
        return DependencyFinder(data + other.data);
    }
    DependencyFinder &operator+=(const DependencyFinder &other)
    {
        used["+="] = true;
    ...
    DependencyFinder operator-() const
    {
        used["uni -"] = true;
        return DependencyFinder(-data);
    }
    DependencyFinder operator-(const DependencyFinder &other) const
    {
        used["bin -"] = true;
    ...
    bool operator<(const DependencyFinder &other) const
    {
        used["<"] = true;
    ...
    friend ostream &operator<<(ostream &os, DependencyFinder const d1)
    {
        used["<<"] = true;
        return os << d1.data;
    }
