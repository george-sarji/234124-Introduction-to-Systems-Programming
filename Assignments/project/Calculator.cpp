...
#define VALID_DEF "\\s*\\(*\\s*([!]*(\\s*(load)\\(\\s*.*\\)\\s*)|([a-zA-Z]+[a-zA-Z0-9]*)|\\s*\\{\\s*([a-zA-Z[;\\]0-9]"\
                "+\\s*(,\\s*[a-zA-Z[;\\]0-9]*\\s*)*)*(\\s*\\|\\s*(<\\s*[a-zA-Z[;\\]0-9]+\\s*,\\s*[a-zA-Z[;\\]0-9]"\
                "+\\s*>)*(\\s*,\\s*<\\s*[a-zA-Z[;\\]0-9]+\\s*,\\s*[a-zA-Z[;\\]0-9]+\\s*>)*)*\\s*\\}\\s*)\\s*([+^\\-\\*]"\
                "([!]*(\\s*(load)\\(\\s*.*\\)\\s*)|([a-zA-Z]+[a-zA-Z0-9]*)|\\s*\\{\\s*([a-zA-Z[;\\]0-9]+s\\s*"\
